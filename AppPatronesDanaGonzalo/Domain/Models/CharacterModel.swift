...
var sampleCharacterData: CharactersModel = [
    ...
    CharacterModel(name: "Maestro Roshi",
    ...
    CharacterModel(name: "Androide 18",
    ...
    CharacterModel(name: "Androide 17",
    ...
    CharacterModel(name: "Trunks del Futuro",
